...
public class AdventureGame {
    ...
    private Map<Compass, String> loadDirections(String nexttPlace) {
        Map<Compass, String> directions = new HashMap<>();
        List<String> nextSteps = Arrays.asList(nexttPlace.split(","));
    ...
    private void visit(Location location) {
        ...
        System.out.println("\fFrom here you can see: ");
