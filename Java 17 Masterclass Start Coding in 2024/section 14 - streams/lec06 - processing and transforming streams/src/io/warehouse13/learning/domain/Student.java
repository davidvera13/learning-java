...
public class Student {
    ...
    public void addCourse(Course course, LocalDate enrollDate) {
        engagements.put(course.courseCode(), new CourseEngagement(course, enrollDate, "Enrollment"));
    }
    ...
    public static Student getRandomStudent(Course... courses) {
        ...
        Student student = new Student(
                getRandomValue("AU", "CA", "CN", "FR", "GB", "IN", "UA", "US"),
        ...
        for(Course course: courses) {
            int currentLecture = random.nextInt(1, course.lectureCount());
            ...
            student.wathLecture(course.courseCode(), currentLecture, month, year);
        }
